...
//
//			// List warnings
//			bwHtml.write("<h2>Warning</h2><ul>");
//			for (int i = 0; i < Warning.warnings.size(); i++) {
//				bwHtml.write("<li><b>" + Warning.warnings.get(i).name + "</b></li><ul>");
//				for (int g = 0; g < Warning.warnings.get(i).lines.size(); g++ ) {
//					bwHtml.write("<li>" + Warning.warnings.get(i).lines.get(g).filename + " @ line " + Warning.warnings.get(i).lines.get(g).line + " : " + Warning.warnings.get(i).lines.get(g).text + "</li>");
//				}
//				bwHtml.write("</ul>");
//			}
//			bwHtml.write("</ul>\r\n");
